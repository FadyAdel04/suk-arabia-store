    ...
    <section className="py-16 bg-white">
      ...
      <div
        ...
        style={{
          ...
          // Electronics circuit board macro photo
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-4 px-8 py-14">
          <div className="text-center md:text-right flex-1">
            ...
            <Link to="/offers">
              <Button
                size="lg"
                className="bg-yellow-400 text-blue-900 font-bold text-lg hover:bg-yellow-300 transition shadow-md"
              >
                تصفح العروض
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <div
              className="relative rounded-2xl p-10 overflow-hidden text-white shadow-xl
            ...
            >
              ...
              <Zap
                className="absolute top-1/2 left-1/3 opacity-20 w-16 h-16 text-teal-200 -z-0 animate-spin"
                style={{
              ...
              <div className="relative z-10">
                ...
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div className="text-center">
                    <div className="text-3xl font-bold text-yellow-100 drop-shadow-sm">
                      45
                    </div>
          ...
          <div className="space-y-6">
            <div className="bg-green-100 rounded-xl p-6 text-center">
              ...
              <p className="text-gray-600 mb-4">
                شحن مجاني لجميع الطلبات أكثر من 200 جنيه
              </p>
              <Link to="/shop">
                <Button
                  variant="outline"
            ...
            <div className="bg-orange-100 rounded-xl p-6 text-center">
              ...
              <p className="text-gray-600 mb-4">خصم 25% على الهواتف الذكية</p>
